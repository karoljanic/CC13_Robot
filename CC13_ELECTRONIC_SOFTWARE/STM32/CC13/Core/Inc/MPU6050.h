...
/* ================================================================================================ *
 | DMP 42-byte FIFO packet structure:                                           |
 |                                                                                                  |
...
class MPU6050 {
    public:
        ...
        /*GYRO_CONFIG register
        	...
        	0x02 --> +/- 1000 degrees/s
        	0x03 --> +/- 2000 degres/s
        */void setFullScaleGyroscopeRange(uint8_t range);
        ...
        /* ACCEL_CONFIG register
			...
			0x02 --> +/- 8g
			0x03 --> +/- 16g
        */void setFullScaleAccelerationRange(uint8_t range);
        ...
        void getAcceleration(Vector<int16_t>* v);
        void getAccelerationFloat(Vector<float>* v);
        ...
        void getRotation(Vector<int16_t>* v);
        void getRotationFloat(Vector<float>* v);
        ...
        // XA_OFFS_* registers
        void setXAccelerationOffset(int16_t offset);

        // YA_OFFS_* register
        void setYAccelerationOffset(int16_t offset);

        // ZA_OFFS_* register
        void setZAccelerationOffset(int16_t offset);

        // XG_OFFS_USR* registers
        void setXGyroscopeOffset(int16_t offset);

        // YG_OFFS_USR* register
        void setYGyroscopeOffset(int16_t offset);

        // ZG_OFFS_USR* register
        void setZGyroscopeOffset(int16_t offset);
		...
		uint8_t DMPGetAcceleration(Vector<int16_t> *v, const uint8_t* packet=0);
		uint8_t DMPGetQuaternion(int16_t *data, const uint8_t* packet=0);
		uint8_t DMPGetQuaternion(Quaternion<float> *q, const uint8_t* packet=0);
		uint8_t DMPGetRotation(Vector<int16_t> *v, const uint8_t* packet=0);
		uint8_t DMPGetLinearAcceleration(Vector<int16_t> *v, Vector<int16_t> *vRaw, Vector<float> *gravity);
		uint8_t DMPGetGravity(Vector<float> *v, Quaternion<float> *q);

		uint8_t DMPGetEuler(float *data, Quaternion<float> *q);
		uint8_t DMPGetYawPitchRoll(float *data, Quaternion<float> *q, Vector<float> *gravity);
